...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        // Lime-green glow — #63D731 = rgb(99,215,49)
        glow:      "0 0 20px rgba(99, 215, 49, 0.30)",
        "glow-lg": "0 0 40px rgba(99, 215, 49, 0.20)",
      ...
      keyframes: {
        ...
        glow: {
          "0%":   { boxShadow: "0 0 5px rgba(99, 215, 49, 0.20)" },
          "100%": { boxShadow: "0 0 20px rgba(99, 215, 49, 0.50)" },
        },
      },
      animation: {
