...
XBAGS is a decentralized social trading platform built on Solana. It combines social media features (posts, feeds, messaging) with real-time token trading capabilities powered by [Bags.fm](https://bags.fm) and [DexScreener](https://dexscreener.com).
