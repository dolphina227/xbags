...
const LandingPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo */}
        <img src={xbagsLogo} alt="XBAGS" className="h-220 sm:h-220 md:h-220" />
        ...
        <motion.button
          ...
          className="mt-4 px-8 py-3.5 rounded-full bg-primary text-primary-foreground font-bold text-sm sm:text-base
                     shadow-[0_0_30px_rgba(0,255,136,0.3)] hover:shadow-[0_0_40px_rgba(0,255,136,0.5)]
                     transition-shadow"
        >
          Launch App
        </motion.button>
